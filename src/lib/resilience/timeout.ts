/**
 * Vendored from cubiczan-resilience (typescript/src/timeout.ts), MIT.
 * No npm registry available, so the primitive is copied in-tree under
 * src/lib/resilience/. Keep in sync with the upstream library.
 */
